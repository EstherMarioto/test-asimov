...
function ArrowLink() {
  return (
    <div className="flex items-center gap-3 text-[#B9FF66] text-xl cursor-pointer group w-fit">
...
export default function CaseStudies() {
  return (
    <section className="py-35 px-25" id="use-cases">
      ...
      {/* Cases */}
      <div className="bg-[#191A23] rounded-card px-15 py-17.5 max-md:px-8 max-md:py-10">
          ...
          {cases.map((c, i) => (
            <div
              ...
              className={`flex flex-col gap-5 px-16 max-lg:px-10 max-md:px-0 ${i === 0 ? 'pl-0' : ''
                ...
                } max-md:border-r-0 max-md:border-b max-md:border-white max-md:pb-10 max-md:mb-10 last:max-md:border-b-0 last:max-md:mb-0 last:max-md:pb-0`}
            >
              <p className="text-white text-lg leading-relaxed">{c.desc}</p>
              <ArrowLink />
            </div>
          ))}
        </div>
